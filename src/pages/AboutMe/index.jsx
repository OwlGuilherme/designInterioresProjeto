...
export const AboutMe = () => {
    return (
        <div className='containerAboutMe'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1350 320"><path fill="#005000" fill-opacity="1" d="M0,320L60,293.3C120,267,240,213,360,202.7C480,192,600,224,720,213.3C840,203,960,149,1080,117.3C1200,85,1320,75,1380,69.3L1440,64L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>          
        </div>
    )
}